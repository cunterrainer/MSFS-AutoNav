...
public:
  ...
  inline int minLocalX() const { return static_cast<int>(_minX); };
  inline int maxLocalX() const { return static_cast<int>(_maxX); };
  inline int minLocalY() const { return static_cast<int>(_minY); };
  inline int maxLocalY() const { return static_cast<int>(_maxY); };
